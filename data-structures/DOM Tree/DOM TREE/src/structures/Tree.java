...
public class Tree {
	...
	public void build() {
		...
		System.out.println("build breakpoint");
	}
	
	/**This method will actually build the tree. The build
	...
	public void replaceTag(String oldTag, String newTag) {
		...
		else if(oldTag.matches("html|body|table|tr|td")){
			System.out.println("Improper replacement");
			return;
		}
		else if(oldTag.equals("li") && (!newTag.equals("p"))){
			System.out.println("Improper replacement");
			return;
		}
		else if(oldTag.matches("p|em|b") && (!newTag.matches("p|em|b"))){
			System.out.println("Improper replacement");
			return;
		}
		else if(oldTag.matches("ol|ul") && (!newTag.matches("ol|ul"))){
			System.out.println("Improper replacement");
			return;
		}
		
		switchTag(this.root, oldTag, newTag);
		System.out.println("replaceTag breakpoint");
	}
