...
public class Finals {
	...
	public static void main(String[] args) {
		...
		System.out.println("ANS: " + bruhRounding(x, 6));
		...
		//flipString
		String shit = "flip this string";
		System.out.println(shit);
		System.out.println(flipString(shit));
	...
	public static double bruhRounding(double x, int n){
		...
		if (n==0){
			...
			x = (x*10.0);
			return bruhRounding(x, n-1)/10.0;
		}
	}
	...
	public static void hoofySort(String[] stuff){
		int numSorted = 1;
